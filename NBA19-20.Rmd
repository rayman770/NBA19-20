...
Also, below is the interactive plot with ggPredict() for this simple linear regression. Note that Rmd / md file doesn't support the interactive plot, so please use R script for this part.
```{r}
library(ggiraph)
